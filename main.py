...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='Res2former', type=str, metavar='MODEL',
                        help='Name of model to train')
    parser.add_argument('--input-size', default=224, type=int, help='images input size')

    parser.add_argument('--drop', type=float, default=0.0, metavar='PCT',
                        help='Dropout rate (default: 0.)')
    parser.add_argument('--drop-path', type=float, default=0.00, metavar='PCT',
                        help='Drop path rate (default: 0.1)')

    parser.add_argument('--qk-scale-factor', type=float, default=-0.5, metavar='PCT',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='../../../../../inspur/hdfs3/imagenet/ILSVRC/Data/CLS-LOC/data/',
                        type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'IMNET', 'IMNET100', 'IMNET200', 'IMNET10'],
                        type=str, help='Image Net dataset path')

    parser.add_argument('--output_dir', default='./2',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--resume', default='./Res2former.pth', help='resume from checkpoint')
...
def main(args):
    ...
    tensor1 = torch.tensor(torch.randn(1, 3, 224, 224), device=device)
    flops1 = FlopCountAnalysis(model, tensor1)
    # # flops, params = profile(model, inputs=(tensor1,))
    flops, params = clever_format([flops1.total(), n_parameters], '%.3f')
    print(f"FLOPs: {flops}, Parameters: {params}")
    # print("FLOPs: ", flops)
    # print('number of params:', parameter_count_table(model))
